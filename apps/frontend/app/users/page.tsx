...
export default async function UsersPage() {
  ...
  return <main className="mx-auto max-w-7xl p-6"><h1 className="text-xl font-semibold">Users</h1><p className="mt-3 text-sm text-muted">Gateway status: {health.status}</p></main>;
}
